				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="callInfoAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="callInfo_handMemo" class="col-md-2 text-right">备注:</label>
						  	 <div class="col-md-8">
				          ...
				          <div class="form-group">
				             ...
				             <span onclick="ajaxCallInfoAdd();" class="btn btn-primary bottom5 top5">呼叫网管</span>
				          </div>
						</form> 
