...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录id</td><td>呼叫会员</td><td>呼叫时间</td><td>处理状态</td><td>处理备注</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=callInfo.getUserObj().getName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="callInfoQueryForm" id="callInfoQueryForm" action="<%=basePath %>CallInfo/frontlist" class="mar_t15" method="post">
