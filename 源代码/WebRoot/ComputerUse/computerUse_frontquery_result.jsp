...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录id</td><td>上机用户</td><td>使用电脑</td><td>计费方式</td><td>上机时间</td><td>下机时间</td><td>是否结账</td><td>结账金额</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=computerUse.getUserObj().getName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="computerUseQueryForm" id="computerUseQueryForm" action="<%=basePath %>ComputerUse/frontlist" class="mar_t15" method="post">
