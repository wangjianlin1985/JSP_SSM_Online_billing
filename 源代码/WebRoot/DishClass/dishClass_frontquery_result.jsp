		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#dishClassListPanel" aria-controls="dishClassListPanel" role="tab" data-toggle="tab">菜品分类列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>DishClass/dishClass_frontAdd.jsp" style="display:none;">添加菜品分类</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>菜品分类id</td><td>菜品分类名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<dishClassList.size();i++) {
					    	            		...
					    	            		DishClass dishClass = dishClassList.get(i); //获取到菜品分类对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=dishClass.getDishClassId() %></td>
 											<td><%=dishClass.getDishClassName() %></td>
 											<td>
 												<a href="<%=basePath  %>DishClass/<%=dishClass.getDishClassId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="dishClassEdit('<%=dishClass.getDishClassId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="dishClassDelete('<%=dishClass.getDishClassId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;菜品分类信息编辑</h4>
      </div>
...
/*删除菜品分类信息*/
function dishClassDelete(dishClassId) {
	if(confirm("确认删除这个记录")) {
		$.ajax({
			type : "POST",
			url : basePath + "DishClass/deletes",
			data : {
				dishClassIds : dishClassId,
			},
