...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Recharge/frontlist">会员充值信息</a></li>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=recharge.getChargeMoney()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">充值时间:</div>
		<div class="col-md-10 col-xs-6"><%=recharge.getChargeTime()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">备注信息:</div>
		<div class="col-md-10 col-xs-6"><%=recharge.getChargeMemo()%></div>
	</div>
	<div class="row bottom15">
