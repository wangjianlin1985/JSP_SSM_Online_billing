...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>UserInfo/frontlist">会员管理</a></li>
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
					 <label for="userInfo_user_name" class="col-md-2 text-right">会员卡号:</label>
					 <div class="col-md-8"> 
					 	<input type="text" id="userInfo_user_name" name="userInfo.user_name" class="form-control" placeholder="请输入会员卡号">
					 </div>
				  </div> 
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_userPhoto" class="col-md-2 text-right">会员照片:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group" style="display:none;">
				  	 <label for="userInfo_userMoney" class="col-md-2 text-right">会员余额:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_userMoney" name="userInfo.userMoney" class="form-control" placeholder="请输入会员余额">
					 </div>
				  </div>
				  <div class="form-group" style="display:none;">
