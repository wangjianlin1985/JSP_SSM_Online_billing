	...
	<ul class="breadcrumb">
		...
		<div class="row"> 
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
		  	 	<span id="userInfo_userMoney_span"></span>
			    <input type="hidden" id="userInfo_userMoney_edit" name="userInfo.userMoney" class="form-control" placeholder="请输入会员余额">
			 </div>
		  </div>
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_userMoney_span").html(userInfo.userMoney);
