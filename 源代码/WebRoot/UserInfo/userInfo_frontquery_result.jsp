...
<%
    ...
    String user_name = (String)request.getAttribute("user_name"); //会员卡号查询关键字
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			<div class="form-group">
				<label for="user_name">会员卡号:</label>
				<input type="text" id="user_name" name="user_name" value="<%=user_name %>" class="form-control" placeholder="请输入会员卡号">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="userInfo_user_name_edit" class="col-md-3 text-right">会员卡号:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="userInfo_user_name_edit" name="userInfo.user_name" class="form-control" placeholder="请输入会员卡号" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_userMoney_edit" class="col-md-3 text-right">会员余额:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_userMoney_edit" name="userInfo.userMoney" class="form-control" placeholder="请输入会员余额">
			 </div>
		  </div>
		  <div class="form-group">
